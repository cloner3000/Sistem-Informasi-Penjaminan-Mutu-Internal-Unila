...
<div id="cari">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2>Berita Acara Audit Mata Kuliah</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">Beranda</a>
                    </li>
                    <li class="breadcrumb-item active">
                        <strong>Berita Acara Audit Mata Kuliah</strong>
                    </li>      
                </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Berita Acara Audit Matakuliah</h5>
                    </div>
                    <div class="ibox-content">
                         <form action="<?php echo base_url().'audit_ps/cetak_berita_acara'?>" method="post"> 
...
<script>
$(document).ready(function(){
    $('#berita_acara').on('click', function (){
        var jadwal_id = $('#jadwal_id').val();
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url().'audit_ps/cetak_berita_acara'?>",
                    beforeSend: function () {
                        let timerInterval
                        swal({
                            title : 'Menunggu',
                            html  : 'Download berita acara...',
                            text : 'Proses Data',
                            time : 3000,
                            onOpen: () => {
                                swal.showLoading()
