<div id="audit-matkul">
    <form action="<?php echo base_url().'audit_ps/save_jawaban'?>" method="post">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-width: 20px;max-width: 20px;" class="text-center">
                            <input   name="jawaban_teori[]" id="jawab<?php echo $bo['id_borang'] ?>" class="text-center form-control b-r-lg bg-white" type="text">
                        </td>
                        <td style="min-width: 30px;max-width: 30px;" class="text-center">
                            ...
                            <input  type="text"  name="skor_teori[]" type="text" id="total<?php echo $bo['id_borang'] ?>" class="subtotal<?php echo $as['id_aspek_penilaian'] ?> text-center form-control b-r-lg bg-white ">
                        </td>
                    </tr>
                    <?php }?>
                    <?php endforeach;?>  
        ...
        <?php if($audit_matkul['sks_prak'] > 0):?>
            <?php $this->view('content/audit/ps/instrument_matakuliah_p');?>
        <?php endif;?>
        <div class="wrapper wrapper-content animated fadeInRight">
            <div>
