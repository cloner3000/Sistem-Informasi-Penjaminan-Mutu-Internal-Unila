                ...
                <div class="tab-content">
                    <div role="tabpanel" id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <form action="<?php echo base_url().'auditor/update_auditor'?>" method="post">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Nama</b></label>
                                    <div class="col-lg-10">
                                    <input type="hidden" value="<?=$detail_user['id_auditor']?>" name="id_auditor" class="form-control" > 
                                        <input name="nama_auditor" type="text" value="<?=$detail_user['nama_auditor']?>"  placeholder="Nama" class="form-control" required> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>NIP</b></label>
                                        <div class="col-lg-10">
                                            <input name="nip_auditor" type="text" value="<?=$detail_user['nip_auditor']?>" placeholder="NIP" class="form-control"  required> 
                                        </div>
                                </div>
                    ...
                    <div role="tabpanel" id="tab-2" class="tab-pane">
                        <div id="ibox1" class="panel-body">
                            <form id="edit_user" action="<?php echo base_url().'auditor/update_user'?>" method="post">
                                <div class="form-group row">
