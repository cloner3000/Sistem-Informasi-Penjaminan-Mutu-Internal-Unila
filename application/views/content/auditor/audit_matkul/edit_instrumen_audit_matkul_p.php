                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php foreach($hasil_jawaban_p as $has):?>
                                    <?php if($bo['id_borang_praktikum'] == $has['borang_praktikum_id']): ?>
                                        <b><p>Jawaban TPM : <?php echo $has['jawaban']?></p></b>
                                    <?php endif; ?>
                            <?php endforeach;?> 
                            </td>
                            ...
                            <td style="min-width: 20px;max-width: 20px;" class="text-center">
                                <?php foreach($hasil_jawaban_p as $has):?>
                                    <?php if($bo['id_borang_praktikum'] == $has['borang_praktikum_id']): ?>
                                        <input value="<?php echo $has['jawaban']?>" name="jawaban_praktikum[]" type="hidden">
                                        <input value="<?php echo $has['jawaban']?>" name="jawaban_praktikum_auditor[]" id="jawab_p<?php echo $bo['id_borang_praktikum'] ?>" class="text-center form-control b-r-lg bg-white" type="text">
                                    <?php endif; ?>
                                <?php endforeach;?> 
                            </td>
                            <td style="min-width: 30px;max-width: 30px;" class="text-center">
                                ...
                                <?php foreach($hasil_jawaban_p as $has):?>
                                    <?php if($bo['id_borang_praktikum'] == $has['borang_praktikum_id']): ?>
                                        <input value="<?php echo $has['sekor']?>" type="hidden"  name="skor_praktikum[]" type="hidden">
                                        <input value="<?php echo $has['sekor']?>" type="text"  name="skor_praktikum_auditor[]" type="text" id="total_p<?php echo $bo['id_borang_praktikum'] ?>" class="subtotal<?php echo $as['id_aspek_penilaian_p'] ?> text-center form-control b-r-lg bg-white ">
                                    <?php endif; ?>
                                <?php endforeach;?> 
