                        ...
                        <td style="min-width: 20px;max-width: 20px;" class="text-center">
                            <?php foreach($hasil_jawaban as $has):?>
                                <?php if($bo['id_borang'] == $has['borang_id']): ?>
                                    ...
                                    <input value="<?php echo $has['jawaban_auditor']?>" name="jawaban_teori_auditor[]" id="jawab<?php echo $bo['id_borang'] ?>" class="text-center form-control b-r-lg bg-white" type="text">
                                <?php endif; ?>
                            <?php endforeach;?>  
                        </td>
                        <td style="min-width: 30px;max-width: 30px;" class="text-center">
                            ...
                            <?php foreach($hasil_jawaban as $has):?>
                                <?php if($bo['id_borang'] == $has['borang_id']): ?>
                                    ...
                                    <input value="<?php echo $has['sekor_auditor']?>" type="text"  name="skor_teori_auditor[]"  id="total<?php echo $bo['id_borang'] ?>" class="subtotal<?php echo $as['id_aspek_penilaian'] ?> text-center form-control b-r-lg bg-white ">
                                <?php endif; ?>
                            <?php endforeach;?> 
                        </td>
                    </tr>
