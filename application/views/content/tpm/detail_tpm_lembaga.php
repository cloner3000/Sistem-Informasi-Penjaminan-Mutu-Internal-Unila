                ...
                <div class="tab-content">
                    <div role="tabpanel" id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <form action="<?php echo base_url().'tpm/tpm_lembaga/update_tpm_lembaga'?>" method="post">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Pusat Lembaga</b></label>
                                    <div class="col-lg-10">
                                        <input type="hidden" value="<?=$detail_user['id_tpm_pusat_lembaga']?>" name="id_tpm_pusat_lembaga" class="form-control" > 
                                        <input type="text" placeholder="Badan Pengelola" class="form-control" disabled value="<?php echo $detail_user['pusat_lembaga'] ?>"> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Nama</b></label>
                                    <div class="col-lg-10">
                                        <input name="nama_tpm_pusat" type="text" value="<?=$detail_user['nama_tpm_pusat']?>"  placeholder="Nama" class="form-control" required> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>NIP</b></label>
                                        <div class="col-lg-10">
                                            <input name="nip_tpm_pusat" type="text" value="<?=$detail_user['nip_tpm_pusat']?>" placeholder="NIP" class="form-control"  required> 
                                        </div>
                                </div>
                    ...
                    <div role="tabpanel" id="tab-2" class="tab-pane">
                        <div id="ibox1" class="panel-body">
                            <form id="edit_user" action="<?php echo base_url().'tpm/tpm_lembaga/update_user'?>" method="post">
                                <div class="form-group row">
