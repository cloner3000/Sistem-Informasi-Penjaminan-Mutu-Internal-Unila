                ...
                <div class="tab-content">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url().'tpm/tpm_lab/update_tpm_lab'?>" method="post">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Laboratorium</b></label>
                                    <div class="col-lg-10">
                                        <input type="hidden" value="<?=$detail_user['id_tpm_lab']?>" name="id_tpm_lab" class="form-control" > 
                                        <input type="text" placeholder="Badan Pengelola" class="form-control" disabled value="<?php echo $detail_user['nama_lab'] ?>"> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Nama</b></label>
                                    <div class="col-lg-10">
                                        <input name="nama_tpm_lab" type="text" value="<?=$detail_user['nama_tpm_lab']?>"  placeholder="Nama" class="form-control" required> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>NIP</b></label>
                                        <div class="col-lg-10">
                                            <input name="nip_tpm_lab" type="text" value="<?=$detail_user['nip_tpm_lab']?>" placeholder="NIP" class="form-control"  required> 
                                        </div>
                                </div>
                    ...
                    <div role="tabpanel" id="tab-2" class="tab-pane">
                        <div id="ibox1" class="panel-body">
                            <form id="edit_user" action="<?php echo base_url().'tpm/tpm_lab/update_user'?>" method="post">
                                <div class="form-group row">
