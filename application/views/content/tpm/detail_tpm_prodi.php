                ...
                <div class="tab-content">
                    <div role="tabpanel" id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <form action="<?php echo base_url().'tpm/tpm_prodi/update_tpm_prodi'?>" method="post">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Program Studi</b></label>
                                    <div class="col-lg-10">
                                        <input type="hidden" value="<?=$detail_user['id_tpm_prodi']?>" name="id_tpm_prodi" class="form-control" > 
                                        <input type="text" placeholder="Badan Pengelola" class="form-control" disabled value="<?php echo $detail_user['program_studi'] ?>"> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>Nama</b></label>
                                    <div class="col-lg-10">
                                        <input name="nama_tpm_prodi" type="text" value="<?=$detail_user['nama_tpm_prodi']?>"  placeholder="Nama" class="form-control" required> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label"><b>NIP</b></label>
                                        <div class="col-lg-10">
                                            <input name="nip_tpm_prodi" type="text" value="<?=$detail_user['nip_tpm_prodi']?>" placeholder="NIP" class="form-control"  required> 
                                        </div>
                                </div>
                    ...
                    <div role="tabpanel" id="tab-2" class="tab-pane">
                        <div id="ibox1" class="panel-body">
                            <form id="edit_user" action="<?php echo base_url().'tpm/tpm_prodi/update_user'?>" method="post">
                                <div class="form-group row">
