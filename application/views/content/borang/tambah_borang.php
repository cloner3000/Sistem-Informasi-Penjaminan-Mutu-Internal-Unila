    ...
    <div class="col-lg-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                <form id="form" method="post" action="<?php echo base_url().'su/borang/set_jenis_borang' ?>" class="wizard-big">
                    <h1>Borang</h1>
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input name="jenis_borang" type="text" placeholder="Nama Borang" class="form-control required">
                                    ...
                                    <div class="form-group">
                                        <label>Tahun *</label>
                                        <input id="confirm" name="tahun" type="number" class="form-control required" placeholder="Tahun">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Judul Borang" name="judul_borang" type="text" class="form-control required">
                                    </div>
                                    <div class="form-group">
                                        <label>Area Borang *</label>
                                        <input placeholder="Area Borang" name="area_borang" type="text" class="form-control required">
                                    </div>
                                    <div class="form-group">
                                        <label>Kode *</label>
                                        <input placeholder="Kode" name="kode" type="text" class="form-control required">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>Tanggal *</label>
                                        <input placeholder="Tanggal" name="tanggal" type="text" class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="2019-09-20">
                                    </div>
                                    <div class="form-group">
                                        <label>No. Revisi *</label>
                                        <input placeholder="No. Revisi" name="no_revisi" type="text" class="form-control required">
                                    </div>
                                    <div class="form-group">
                                        <label>Status *</label>
